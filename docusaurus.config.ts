...
const config: Config = {
  ...
  tagline: 'A comprehensive textbook on building, simulating, and deploying AI systems in physical humanoid robots',
  favicon: undefined,
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              to: '/docs/module-2-gazebo/introduction',
            },
            {
              label: 'Module 3: NVIDIA Isaac',
              to: '/docs/module-3-isaac/introduction',
            },
            {
              label: 'Module 4: VLA',
